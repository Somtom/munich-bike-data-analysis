...
preprocessing later. The functions can be found in the Github project. 
...
Station **Arnulf** has a special characteristic: The counter is located on a one way bicycle lane.
...
Let's plot the 15 minute data for the events in the two years, we observed these high counts:
...
![Picture source: radlhauptstadt.muenchen.de](https://radlhauptstadt.muenchen.de/fileadmin/_processed_/0/c/csm_2017-09-03-Radlhauptstadt-Ringparade-Simone-Naumann-MG_3451-Edit_841d8ba11b.jpg)
...
However, we also see some individual trends or characteristics for some stations:

* Station **Hirsch** shows a ongoing trend of rising bike counts from year to year
* At **Arnulf Street's** counting station one can see two peak years in 2013 and 2014. This peak 
...
* One can clearly see the some events taking place in **Olympia Park** represented by peaks in the data
...
bike_cnt_day %>% 
  ...
  ggtitle("In general, highest bike counts occur during Juli.",
...
We look at the distribution of measured values within each weather variable **for the month Juli**.
...
Thus, they would perhaps pass the counting stations more than once or pass a counting stations
